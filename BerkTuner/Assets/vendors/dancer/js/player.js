(function () {
  ...
  Dancer.setOptions({
    flashSWF: URLS.flashSWF,
    flashJS: URLS.flashJS
  });
  ...
  function newParticleMat( color ) {
    ...
    return new THREE.ParticleBasicMaterial({
      ...
      map: THREE.ImageUtils.loadTexture(URLS.particleBase + sprite + '.png'),
  ...
  function loaded() {
    ...
    if (dancer.audioAdapter.audio != null && dancer.isPlaying() != true) {
        dancer.play();
    }
